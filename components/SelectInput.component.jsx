...
const SelectInput = ({ placeholder, name, displayError, value, inputClasses, options }) => {
    ...
    return (
        <div className="w-full">
            <div className="relative">
                ...
                <select 
                    defaultValue={value}
                    className={" appearance-none w-full h-[50px] rounded-md border px-4 py-2 pt-4 bg-white-100 mb-2 " + inputClasses + (displayError ? " border-red-200  " : " border-white-200 ")} 
                    onFocus={addFocus} 
                    onBlur={removeFocus} 
                    name={name} 
                >
